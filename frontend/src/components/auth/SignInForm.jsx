...
const SignInForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    dispatch({
      type: 'SET_USER',
      payload: { name: 'Ada Lovelace', initials: 'AL', role: 'Admin', email },
    })
    dispatch({
      type: 'SET_WORKSPACE',
      payload: { name: 'Acme Inc.', plan: 'Growth', seats: '12' },
    })
        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
            <div className="mb-6">
              ...
              <p className="text-sm text-slate-500 mt-1">Sign in to your TR-Insight-Forge workspace.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <Link to="#" className="text-sm text-primary-600 hover:text-primary-700">Forgot?</Link>
                </div>
                <input
                  type="password"
                  value={password}
            ...
            <p className="text-center text-sm text-slate-500 mt-6">
              Don't have an account? <Link to="/signup" className="text-primary-600 hover:text-primary-700 font-medium">Create one</Link>
            </p>
          </div>
        </div>
      </div>
